...
const HeaderApp = ({setIsOpen}) => {
  return (
    <>
    <header className={styles.header_app}>
        <div className={styles.container}>
            <button onClick={() => setIsOpen(true)} className={styles.link_platform}>Vincular una plataforma <i className={`${styles.link_icon} fa-solid fa-link`}></i></button>
